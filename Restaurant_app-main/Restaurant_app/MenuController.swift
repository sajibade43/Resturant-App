...
class MenuController {
    //static variablesto be used within other classes
    ...
    //Get method : /categories request an array of strings
    ...
    //a GET for items within a category
    ...
    //post method: /order containing the user's order when it's time to communicate back to the restaurant's serve
